...
(function() {
  this.initOptions = function() {
    var colorName, colorRGBstring, controller;
    g.parameters = {};
    ...
    g.parameters.zoom = {
      ...
      onChange: function(value) {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          div = _ref[_i];
          _results.push(div.zoom(g.project.view.zoom));
        }
        return _results;
      },
      onFinishChange: function(value) {
    ...
    g.generalFolder.add({
      zoom: 100
    }, 'zoom', 10, 200).name("Zoom").onChange(function(value) {
      var div, _i, _len, _ref, _results;
      g.project.view.zoom = value / 100.0;
      g.updateGrid();
      _ref = g.divs;
    ...
    g.sizePickerJ.slider().on('slide', function(event) {
      return g.fontSize = event.value;
    });
    g.usedFonts = [];
  ...
  this.loadFonts = function() {
    var effect, font, fontLink, i, newFont, _i, _j, _len, _len1, _ref, _ref1, _results;
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      ...
      _results.push($('head').append(fontLink));
    }
    return _results;
  };
  ...
  this.initTextOptions = function(data, textStatus, jqXHR) {
    ...
    return g.fontSubmitJ.click(function(event) {
      return g.setFontStyles();
    });
  };
    ...
    switch (parameter.type) {
      case 'color':
        ...
        controller.rSetValue = function(value, item, checked) {
          ...
          return checkboxJ[0].checked = checked;
        };
        break;
      case 'slider':
      case 'checkbox':
