...
(function() {
  define(['utils', 'paper', 'coffee', 'mainRasterizer', 'coordinateSystems', 'global', 'ajax', 'options', 'socket', 'command', 'item', 'div', 'lock', 'path', 'tools', 'mod', 'rasterizer', 'editor', 'sound', 'modal', 'jquery', 'jqueryUi', 'mousewheel', 'scrollbar', 'tween', 'typeahead', 'prefix', 'modal', 'ace'], function(utils, paper, CoffeeScript) {
    ...
    init = function() {
      var hueRange, i, minHue, step, url, xmlhttp, _i;
      ...
      xmlhttp.onreadystatechange = function() {
        var classExpressions, classMap, className, end, expression, expressions, lines, pathClass, source, sources, start, _j, _k, _l, _len, _len1, _ref, _ref1, _ref2, _ref3;
        if (xmlhttp.readyState === 4 && xmlhttp.status === 200) {
          ...
          for (_k = 0, _len1 = classExpressions.length; _k < _len1; _k++) {
            expression = classExpressions[_k];
