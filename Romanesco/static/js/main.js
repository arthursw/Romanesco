...
(function() {
  define(['utils', 'paper', 'coffee', 'coordinateSystems', 'global', 'ajax', 'options', 'socket', 'command', 'item', 'div', 'lock', 'path', 'tools', 'mod', 'rasterizer', 'editor', 'sound', 'modal', 'jquery', 'jqueryUi', 'mousewheel', 'scrollbar', 'tween', 'typeahead', 'prefix', 'ace'], function(utils, paper, CoffeeScript) {
