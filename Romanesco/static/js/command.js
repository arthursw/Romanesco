...
(function() {
  var AddPointCommand, ChangeParameterCommand, ChangeSelectedPointTypeCommand, Command, CommandManager, CreateDivCommand, CreateLockCommand, CreatePathCommand, DeleteDivCommand, DeleteLockCommand, DeletePathCommand, DeletePointCommand, ModifyPointCommand, ModifySpeedCommand, MoveCommand, ResizeCommand, RotationCommand, SelectCommand,
  ...
  ResizeCommand = (function(_super) {
    ...
    ResizeCommand.prototype["do"] = function() {
      this.item.setRectangle(this.newRectangle);
      ResizeCommand.__super__["do"].call(this);
    };

    ResizeCommand.prototype.undo = function() {
      this.item.setRectangle(this.previousRectangle);
  ...
  RotationCommand = (function(_super) {
    ...
    RotationCommand.prototype["do"] = function() {
      this.item.setRotation(this.newRotation);
      RotationCommand.__super__["do"].call(this);
    };

    RotationCommand.prototype.undo = function() {
      this.item.setRotation(this.previousRotation);
  ...
  CreatePathCommand = (function(_super) {
    ...
    function CreatePathCommand(item, name) {
      ...
      CreatePathCommand.__super__.constructor.call(this, name);
      return;
    }
  ...
  CreateDivCommand = (function(_super) {
    ...
    function CreateDivCommand(div, name) {
      this.div = div;
      if (name == null) {
        name = null;
      }
      ...
      CreateDivCommand.__super__.constructor.call(this, name);
      return;
    }

    CreateDivCommand.prototype.duplicate = function() {
      this.divConstructor.duplicate(this.rectangle, this.data);
      this.div = null;
    };
    ...
    CreateDivCommand.prototype.end = function() {
      this.rectangle = this.div.rectangle;
  ...
  DeleteDivCommand = (function(_super) {
    ...
    function DeleteDivCommand(div, name) {
      this.div = div;
      if (name == null) {
        name = null;
      }
      DeleteDivCommand.__super__.constructor.call(this, this.div, name || 'Delete div', true);
    }
  ...
  CreateLockCommand = (function(_super) {
    ...
    function CreateLockCommand(item, name) {
      CreateLockCommand.__super__.constructor.call(this, item, 'Create lock');
    }
  ...
  DeleteLockCommand = (function(_super) {
    ...
    function DeleteLockCommand(item, name) {
