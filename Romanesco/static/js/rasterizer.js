...
(function() {
  ...
  define(['utils', 'jquery', 'paper'], function(utils) {
    var FastTileRasterizer, Rasterizer, TileRasterizer, g;
    g = utils.g();
    Rasterizer = (function() {
      Rasterizer.TYPE = 'paper';
    ...
    TileRasterizer = (function(_super) {
      ...
      TileRasterizer.prototype.quantizeBounds = function(bounds, scale) {
        var quantizedBounds;
        if (bounds == null) {
          bounds = view.bounds;
        }
      ...
      TileRasterizer.prototype.createUpdateRaster = function(x, y, zoom) {
      ...
      TileRasterizer.prototype.rasterizeCallback = function(step) {
        var areas, item, pk, viewOnFrame, _i, _j, _len, _len1, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6;
    ...
    FastTileRasterizer = (function(_super) {
      __extends(FastTileRasterizer, _super);

      FastTileRasterizer.TYPE = 'fast tile';

      function FastTileRasterizer() {
        FastTileRasterizer.__super__.constructor.call(this);
        return;
      }

      FastTileRasterizer.prototype.loadItem = function(item) {
        FastTileRasterizer.__super__.loadItem.call(this, item);
        item.rasterize();
      };

      FastTileRasterizer.prototype.selectItem = function(item) {
        FastTileRasterizer.__super__.selectItem.call(this, item);
      };

      FastTileRasterizer.prototype.deselectItem = function(item) {
        item.rasterize();
        FastTileRasterizer.__super__.deselectItem.call(this, item);
      };

      return FastTileRasterizer;
