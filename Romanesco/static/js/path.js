...
(function() {
  var Checkpoint, EllipseShape, FaceShape, GeometricLines, GridPath, Meander, PrecisePath, RPath, RShape, RectangleShape, ShapePath, SpeedPath, SpiralShape, StarShape, StripeAnimation, ThicknessPath,
  ...
  RPath = (function() {
    ...
    RPath.prototype.getAreas = function() {
    ...
    RPath.prototype.parameterChanged = function(update) {
      ...
      if (this.previousBoundingBox == null) {
        this.previousBoundingBox = this.getBounds();
      }
      this.draw();
      if (update) {
        g.defferedExecution(this.update, this.getPk());
    ...
    RPath.prototype.save = function() {
      ...
      if (!((_ref = this.data) != null ? _ref.animate : void 0)) {
        g.updateRasters(this.getBounds());
      }
    };
      ...
      if (!((_ref = this.data) != null ? _ref.animate : void 0)) {
        ...
        if (this.previousBoundingBox != null) {
          ...
          if (rectangle.intersects(this.previousBoundingBox) && union.area < this.previousBoundingBox.area * 2) {
            ...
            g.updateRasters(this.previousBoundingBox);
          }
  ...
  PrecisePath = (function(_super) {
    ...
    PrecisePath.prototype.draw = function(simplified, loading) {
      var controlPathLength, error, nIteration, nf, offset, reminder, step, _ref;
      if (simplified == null) {
        simplified = false;
      }
      if (loading == null) {
  ...
  ThicknessPath = (function(_super) {
    ...
    ThicknessPath.prototype.drawUpdate = function(offset) {
  ...
  Meander = (function(_super) {
    ...
    Meander.prototype.drawUpdate = function(offset) {
  ...
  GridPath = (function(_super) {
    ...
    GridPath.prototype.drawUpdate = function(offset) {
  ...
  GeometricLines = (function(_super) {
    ...
    GeometricLines.prototype.drawUpdate = function(offset) {
  ...
  StripeAnimation = (function(_super) {
    ...
    StripeAnimation.prototype.initialize = function() {
      var black, i, modalAddImageButtonJ, modalBodyJ, modalContentJ, modalInputJ, modalJ, n, result, size, stripes, transparent, width, x, y, _i, _j, _ref, _ref1;
      this.setAnimated(this.data.animate);
      modalJ = $('#customModal');
      ...
      for (x = _i = 0, _ref = size.width - 1; 0 <= _ref ? _i <= _ref : _i >= _ref; x = 0 <= _ref ? ++_i : --_i) {
        for (y = _j = 0, _ref1 = size.height - 1; 0 <= _ref1 ? _j <= _ref1 : _j >= _ref1; y = 0 <= _ref1 ? ++_j : --_j) {
          i = g.roundToLowerMultiple(x, width) % n;
          result.setPixel(x, y, rasters[i].getPixel(x, y));
          stripes.setPixel(x, y, i === 0 ? transparent : black);
        }
      }
    };
