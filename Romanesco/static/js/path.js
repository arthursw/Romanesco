...
(function() {
  var Checkpoint, DynamicBrush, EllipseShape, FaceShape, GeometricLines, GridPath, Meander, Medusa, PaintBrush, PaintGun, PrecisePath, RPath, RShape, RectangleShape, ShapePath, SpeedPath, SpiralShape, StarShape, StripeAnimation, ThicknessPath,
  ...
  PrecisePath = (function(_super) {
    ...
    PrecisePath.prototype.modifyPointTypeCommand = function(rtype) {
      g.commandManager.add(new ModifyPointTypeCommand(this, this.selectionState.segment, rtype), true);
    };
  ...
  this.pathClasses.push(this.Medusa);
